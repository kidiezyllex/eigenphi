...
const Portfolio = () => {
    const { data, isLoading } = useGetMevByAddress('0x1f2f10d1c40777ae1da742455c65828ff36df387')
    ...
    if (!data || data.length === 0) {
        return (
            <div className='p-6'><Card className="bg-mainBackgroundV1 border border-mainBorderV1">
                <CardHeader className="flex flex-row items-center justify-between pb-2">
                    <div className="flex items-center">
                        ...
                        <TooltipProvider>
                            <Tooltip>
                                ...
                                <TooltipContent>
                                    <p className="w-[200px] text-xs">No MEV transactions found for this address.</p>
                                </TooltipContent>
                            </Tooltip>
                        </TooltipProvider>
                    </div>
                ...
                <CardContent className="p-6 flex justify-center items-center">
                    <p className="text-gray-400">No MEV transactions found for this address.</p>
                </CardContent>
            </Card></div>
        )
    }
