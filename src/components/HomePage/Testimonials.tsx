...
const testimonials = [
  {
    ...
    content: 'Tôi rất hài lòng với chất lượng giày và dịch vụ khách hàng tại WidoFile. Sản phẩm đúng như mô tả và được giao hàng nhanh chóng.',
    rating: 5,
  },
  {
    id: 2,
  ...
  },
  {
    ...
    content: 'WidoFile luôn có những mẫu giày thể thao mới nhất và chính hãng. Tôi tin tưởng và sẽ tiếp tục mua sắm tại đây.',
    rating: 5,
  },
];
