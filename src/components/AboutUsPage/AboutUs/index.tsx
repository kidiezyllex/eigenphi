...
const testimonialData = [
    {
        ...
        description: "Tôi rất hài lòng với dịch vụ của WidoFile. Sản phẩm chất lượng, giao hàng nhanh chóng và nhân viên phục vụ rất nhiệt tình.",
    ...
    },
    {
        ...
        description: "Mua sắm tại WidoFile là một trải nghiệm tuyệt vời. Sản phẩm đa dạng, giá cả phải chăng và dịch vụ chăm sóc khách hàng rất tốt.",
    ...
    },
    {
        ...
        description: "Những đôi giày tôi mua từ WidoFile luôn bền đẹp và thoải mái. Tôi đã giới thiệu cửa hàng cho tất cả bạn bè của mình.",
    ...
    },
    {
        ...
        description: "Nhân viên tại WidoFile luôn nhiệt tình và am hiểu về sản phẩm. Họ giúp tôi chọn được đôi giày phù hợp nhất với nhu cầu của mình.",
    ...
    },
    {
        ...
        description: "Rất yên tâm khi mua sắm tại WidoFile vì họ chỉ bán hàng chính hãng. Giá cả hợp lý và chất lượng đảm bảo.",
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        >
                            ...
                            <p className="text-lg text-gray-600 dark:text-gray-400 mb-8">
                                WidoFile được thành lập với sứ mệnh mang đến cho khách hàng những sản phẩm giày chất lượng cao với giá cả phải chăng. Chúng tôi tin rằng mỗi người đều xứng đáng được sở hữu những đôi giày thoải mái và thời trang.
                            </p>
                            <p className="text-lg text-gray-600 dark:text-gray-400 mb-8">
            ...
            <section className="py-24 bg-gradient-to-br from-[#2C8B3D]/10 to-[#F2A024]/10">
                <div className="container mx-auto px-4">
                    <motion.div
                        ...
                        transition={{ duration: 0.5 }}
                    >
                        <h2 className="text-4xl font-bold text-gray-900 dark:text-white mb-6">Tại sao chọn WidoFile?</h2>
            ...
            <section id="team" className="py-24">
                <div className="container mx-auto px-4">
                    ...
                    >
                        ...
                        <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
                            WidoFile được vận hành bởi một đội ngũ trẻ trung, năng động và đầy nhiệt huyết. Chúng tôi luôn nỗ lực để mang đến những sản phẩm và dịch vụ tốt nhất cho khách hàng.
                        </p>
                    </motion.div>
